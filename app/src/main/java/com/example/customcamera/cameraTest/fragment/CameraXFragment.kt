package com.example.customcamera.cameraTest.fragment
...
import com.example.customcamera.ImageAnalyser
import com.example.customcamera.R
import com.example.customcamera.cameraTest.interaction_camera.CameraInteractionFragment
...
const val KEY_EVENT_ACTION = "Key event action"
typealias lumaListener = (luma: Double)->Unit

class CameraXFragment : Fragment(),CameraInteractionFragment.Interactor {
    ...
    private var listener: TestCameraCustom? = null
    ...
    override fun onAttach(context: Context) {
        ...
        if(context is TestCameraCustom){
            listener = context
        }else
        {
